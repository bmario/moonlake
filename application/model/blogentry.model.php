...
class blogentry_Model extends Moonlake_Model_Model {
    protected $area   = 'blog_entry';
    protected $fields = array(
        'name'        => Moonlake_Model_ModelBackend::TYPE_STR,
        'time'        => Moonlake_Model_ModelBackend::TYPE_INT,
        'short'        => Moonlake_Model_ModelBackend::TYPE_STR,
        'content'    => Moonlake_Model_ModelBackend::TYPE_TXT
    );
}
